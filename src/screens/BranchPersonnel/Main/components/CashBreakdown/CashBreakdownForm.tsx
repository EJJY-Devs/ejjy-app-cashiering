	...
	const getFormDetails = useCallback(
		() => ({
			...
			Schema: Yup.object().shape({
				coins_25: Yup.number().required().max(65535).label('25 Coins'),
				coins_50: Yup.number().required().max(65535).label('50 Coins'),
				coins_1: Yup.number().required().max(65535).label('1 Coins'),
				coins_5: Yup.number().required().max(65535).label('5 Coins'),
				coins_10: Yup.number().required().max(65535).label('10 Coins'),
				bills_20: Yup.number().required().max(65535).label('20 Bills'),
				bills_50: Yup.number().required().max(65535).label('50 Bills'),
				bills_100: Yup.number().required().max(65535).label('100 Bills'),
				bills_200: Yup.number().required().max(65535).label('200 Bills'),
				bills_500: Yup.number().required().max(65535).label('500 Bills'),
				bills_1000: Yup.number().required().max(65535).label('1000 Bills'),
			}),
		}),
		[],
	);
