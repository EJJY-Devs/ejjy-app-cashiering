...
export const endSessionShortcutKeysDisplay = ['F3', 'CTRL + E'];
export const deleteItemShortcutKeysDisplay = ['F4', 'CTRL + D'];
export const discountShortcutKeysDisplay = ['F5', 'CTRL + F'];
...
export const holdResumeShortcutKeysDisplay = ['F9', 'CTRL + H'];
